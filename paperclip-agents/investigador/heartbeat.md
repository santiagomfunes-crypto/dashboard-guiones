...
Body: {
  "agent_id": "33ccac15-166f-4a93-8ec1-3cc939911c18",
...
```
GET https://pgnmpxqljxrpnvexcygh.supabase.co/rest/v1/agent_memories?agent_id=eq.33ccac15-166f-4a93-8ec1-3cc939911c18&importance=gte.7&order=created_at.desc&limit=20
```
