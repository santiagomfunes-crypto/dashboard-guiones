...
1. `referencia/voz-santiago.md` — tono y estilo
2. `referencia/framework-angulos.md` — ángulos disponibles
3. `referencia/datos-tandil.md` — datos para usar
4. `contexto/info-personal.md` — identidad de Santiago
5. `contexto/info-negocio.md` — servicios del negocio
...
Guardá el guion generado en `salidas/guiones/` con el formato:
